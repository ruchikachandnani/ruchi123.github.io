...
<div class="xyz" style="width: 400px;">
	<h2 style="text-transform: capitalize;"><center>Oracle</center></h2>
	<ul>
				<li>SQL Plus</li>
<li>Define database</li>
<li>Explain basic SQL statements</li>
<li>Describe the various types of functions available in SQL</li>
<li>Describe and use the different types of joins</li>
<li>Describe subqueries</li>
<li>Describe the process of producing readable output with iSQL*Plus</li>
<li>Explain data manipulation using SQL statements</li>
<li>Describe constraints and views</li>
<li>Describe the various database objects</li>
<li>List and explain Oracle 9i extensions to DML and DDL statements</li>
<li>PL-SQL</li>
<li>Describe the features and syntax of PL/SQL</li>
<li>Explain writing executable statements</li>
<li>Explain the control structures</li>
<li>Describe and use composite data types</li>
<li>Explain the process of writing explicit cursors</li>
<li>Describe subprogrammes</li>
<li>Describe the use of functions</li>
<li>Describe packages in PL/SQL</li>
<li>List and explain Oracle server-supplied packages</li>
<li>Describe triggers</li>
			</ul>
</div>
</div>
