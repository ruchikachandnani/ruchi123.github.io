...
<div class="xyz" style="width: 400px;">
	<h2 style="text-transform: capitalize;"><center>SEO (Search Engine Optimization)</center></h2>
	<ul>
				<li>Understanding SEO</li>
<li>Search Engine Basics</li>
<li>Long Tail Search</li>
<li>SEO Plan</li>
<li>SEO Strategies</li>
<li>Website for SEO</li>
<li>Keywords and Website</li>
<li>Pay-per-click SEO</li>
<li>Pay-per-click Strategies</li>
<li>Scaling Keywords</li>
<li>Campaign Targeting</li>
<li>Managing keyword Migration</li>
<li>Keyword tool and Services</li>
<li>Tagging Website</li>
<li>The Content</li>
<li>Using Communities</li>
<li>Links and Linkage</li>
<li>Optimizing Search Strategies</li>
<li>Adding site to Directory</li>
<li>Pay for inclusion Services</li>
<li>Robots, Spiders and Crawlers</li>
<li>SEO Spams</li>
<li>Social-Media Optimization</li>
<li>Mobile Search Engine Optimization</li>
<li>Montizing Traffic</li>
<li>Plugging in to SEO</li>
<li>Automated Optimization</li>
<li>Maintaining SEO</li>
<li>SEO Management</li>
<li>Analysing Success</li>
			</ul>
</div>
</div>
