...
{display:none;}
    ...
    input[type=button]:nth-child(even){background-color:  #808080;}
</style>
...
$result=mysqli_query($con,$sql);
        echo "<center><h2>Registeration Database</center></h2>";
echo "<table border='2 px' align='center' >";
        echo "<table border='1 px' align='center' >";
echo "<tr> <th>Registeration no</th> <th>FirstName</th> <th>LastName</th> <th>Contact</th> <th>Email</th> <th>Address</th> <th>Course</th> <th>Update</th></tr>";
...
while($row=mysqli_fetch_array($result))
{
    ...
    echo "<td>";
    echo "<a href='upreg1.php?regno=".$row["regno"]." && firstname=".$row["firstname"]." && lastname=".$row["lastname"]." && contact=".$row["contact"]." && email=".$row["email"]." && address=".$row["address"]." && course=".$row["course"]."  '>";
