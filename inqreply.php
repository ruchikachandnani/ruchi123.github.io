...
$result=mysqli_query($con,$sql);
        echo "<center><h2>Inquiry Database</center></h2>";
echo "<table border='2 px' align='center' >";
        echo "<tr> <th>Inquiry number</th> <th>Message</th> <th>Reply</th> </tr>";
while($row=mysqli_fetch_array($result))
{
    echo "<tr>";
     echo "<td>".$row["inqno"]."</td>";
    echo "<td>".$row["message"]."</td>";
         echo "<td>";
    echo "<a href='inqreply1.php?inqno=".$row["inqno"]." && message=".$row["message"]." '>";
