...
<div style="float: right;  margin-top: 30px;margin-right: 100px;width: 620px;">

  <div style="float: left;">
  <div  id="i1" class="images" style="background-color: #ff668c;position: absolute;z-index: 1;height: 100px;width: 400px;font-family: Consolas;font-size: 20px;padding-top: 100px;" >
  <center>Entrance View</center>
</div>

    <img src="pic5.jpeg" height="200px" width="400px"  onmouseleave="iml('i1');" onmouseenter="ime('i1');">
  </div>
  <div style="clear: both;float: right;margin-top: 25px;">
  <div  id="i2" class="images" style="background-color: #ff668c;position: absolute;z-index: 1;height: 100px;width: 400px;font-family: Consolas;font-size: 20px;padding-top: 100px;" >
 <center>Theory Classroom</center>
</div>

    <img src="pic9.jpg" height="200px" width="400px" onmouseleave="iml('i2');" onmouseenter="ime('i2');">
  </div>
  <div style="clear: both;float: left;margin-top: 25px;">
  <div  id="i3" class="images" style="background-color: #ff668c;position: absolute;z-index: 1;height: 100px;width: 400px;font-family: Consolas;font-size: 20px;padding-top: 100px;" >
  <center>Theory Classroom</center>
</div>

    <img src="pic10.jpg" height="200px" width="400px" onmouseleave="iml('i3');" onmouseenter="ime('i3');">
  </div>
...
<div style="float: right;  margin-top: 30px;margin-right: 100px;width: 620px;">
    ...
    <div  id="i4" class="images" style="background-color: #ff668c;position: absolute;z-index: 1;height: 100px;width: 400px;font-family: Consolas;font-size: 20px;padding-top: 100px;" >
  <center>Students in Computer Lab</center>
</div>

    <img src="pic11.jpg" height="200px" width="400px" onmouseleave="iml('i4');" onmouseenter="ime('i4');">
  </div>
  <div style="clear: both;float: left;margin-top: 25px;">
  <div  id="i5" class="images" style="background-color: #ff668c;position: absolute;z-index: 1;height: 100px;width: 400px;font-family: Consolas;font-size: 20px;padding-top: 100px;" >
  <center>Students</center>
</div>

    <img src="pic7.jpg" height="200px" width="400px" onmouseleave="iml('i5');" onmouseenter="ime('i5');">
  </div>
    ...
    <div style="margin-top: 1300px;" class="cpy">
        <center>
		<?php
        $dt=date("Y");
