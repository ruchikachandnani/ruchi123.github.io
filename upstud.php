...
echo "<tr> <th>Enrollment no</th> <th>FirstName</th> <th>LastName</th> <th>Contact</th> <th>Address</th> <th>Email</th> <th>Course</th> <th>Update</th></tr>";
...
while($row=mysqli_fetch_array($result))
{
    ...
    echo "<td>";
    echo "<a href='upstud1.php?enrollno=".$row["enrollno"]." && firstname=".$row["firstname"]." && lastname=".$row["lastname"]." && contact=".$row["contact"]." && address=".$row["address"]." && email=".$row["email"]." && course=".$row["course"]."  '>";
