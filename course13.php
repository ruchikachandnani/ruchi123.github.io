...
<div class="xyz" style="width: 400px;">
	<h2 style="text-transform: capitalize;"><center>Final Year Project Training</center></h2>
	<p>Anik Computers provides Training, Outsourcing and Placement Company offering a wide array of solutions customized for a range of key verticals and horizontals in the Software Technologies segment. From corporate training in ASP.Net, PHP, Java, Software Testing, and Soft-skills to Live Project Training for the implementation of the right tools for enterprise wide planning, software development and Testing, Anik service portfolio encompasses the entire range of solutions required by the IT industry. Our training methodology in ASP.Net, PHP and Java includes intensive theory and live project training for all students. We also offer placement services to fresher and experienced professionals in Ahmedabad, Baroda, Surat and Rajkot.<br>
			Which Includes Course Contents:<br></p>
			<ul>
			<li>	HTML</li>
<li>CSS</li>
<li>JavaScript</li>
<li>Asp.Net / PHP / Advanced Java</li>
<li>Training By Industry Expert</li>
<li>Training Experience and Certificate</li>
			</ul>
</div>
</div>
