...
function carousel() {
    ...
    <?php echo "<center><h2>Student Update Form</center></h2>";?>
    <div style="margin-top: 30px;padding-left: 40px;
	font-size: 18px;margin-left: 450px;
	line-height: 35px;	font-family: Consolas;
	">
    <form action="upstud2.php" method="post" class="formcss">
                Enrollment number:<br><input type="text" name="enrollno" value="<?php echo $_REQUEST["enrollno"]?>" readonly><br>
				...
				Course:<br><input type="text" name="course" value="<?php echo $_REQUEST["course"]?>"><br>
