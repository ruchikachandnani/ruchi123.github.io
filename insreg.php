...
{display:none;}
    ...
    input[type=button] {height: 30px;background-color: #666666;color: white;font-size: 18px;cursor: pointer;width: 100px;}
...
echo "<tr> <th>Registeration no</th> <th>FirstName</th> <th>LastName</th> <th>Contact</th> <th>Email</th> <th>Address</th> <th>Course</th></tr>";
...
?>
    ...
    <div style="margin-top: 100px;">
        <div style="float:right;margin-right: 650px;"><?php  echo "<a href='insreg1.php'>";
    echo "<input type='button' value='INSERT'/>";
