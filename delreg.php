...
echo "<tr> <th>Registeration no</th> <th>FirstName</th> <th>LastName</th> <th>Contact</th> <th>Email</th> <th>Address</th> <th>Course</th> <th>Delete</th></tr>";
...
while($row=mysqli_fetch_array($result))
{
    ...
    echo "<td>";
    echo "<a href='delreg1.php?regno=".$row["regno"]."'>";
