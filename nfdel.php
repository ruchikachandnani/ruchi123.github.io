...
$result=mysqli_query($con,$sql);
        echo "<center><h2>Notification Database</center></h2>";
echo "<table border='2 px' align='center' >";
         echo "<tr> <th>Notification</th> <th>Date</th> <th>Checked</th> <th>Notification no</th> <th>Delete</th> </tr>";
while($row=mysqli_fetch_array($result))
{
    ...
    echo "<td>".$row["notifyno"]."</td>";
    echo "<td>";
    echo "<a href='nfdel1.php?notifyno=".$row["notifyno"]."'>";
