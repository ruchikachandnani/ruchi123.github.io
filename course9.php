...
<div class="xyz" style="width: 400px;">
	<h2 style="text-transform: capitalize;"><center>Asp.Net</center></h2>
<ul>
				<li>HTML</li>
<li>CSS</li>
<li>Introduction to Asp.Net</li>
<li>Configure and use of Visual Studio</li>
<li>Variables</li>
<li>Condition and Loops</li>
<li>Standard Server Controls</li>
<li>Validation Controls</li>
<li>Login Controls</li>
<li>Navigation Controls</li>
<li>Programming Asp.net Pages</li>
<li>Working with Master Pages</li>
<li>Themes and Skins</li>
<li>Working with Ado.Net</li>
