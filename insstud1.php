...
function carousel() {
    ...
    <?php echo "<center><h2>Student Database</center></h2>";?>
    <div style="margin-top: 30px;padding-left: 40px;
	font-size: 18px;margin-left: 450px;
	line-height: 35px;	font-family: Consolas;
	">
    <form action="insstud2.php" method="post" class="formcss">
                Enrollment no:<br><input type="text" name="enrollno" placeholder="Enter Enrollment no"><br>
				...
				Course:<br><input type="text" placeholder="Course Details" name="course"><br>
