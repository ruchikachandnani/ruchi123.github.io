...
<div class="login">
	<div style="background-color: #ff668c;padding-top: 10px;height: 40px;border:0.5px solid black;font-size: 20px;
"><center>ADMIN LOGIN</center></div>
	<div style="border-bottom:  0.5px solid black;
border-right: 0.5px solid black;
border-left:0.5px solid black;
">
		<form action="admnlogin.php" method="post">
             <?php
