...
<div class="xyz" style="width: 400px;">
	<h2 style="text-transform: capitalize;"><center>Vb.Net</center></h2>
<ul>
				<li>Describe the basics of VB.NET language</li>
<li>Explain the various programming constructs</li>
<li>Describe interfaces, namespaces, and collections</li>
<li>Explain database programming and assemblies</li>
<li>Explain the various Windows Forms controls</li>
<li>Common Controls like Label, Textbox, Combobox etc.</li>
<li>Menu and Toolbars</li>
<li>Dialogs</li>
<li>Data Controls like DataGridView, Dataset</li>
<li>Explain ADO.NET programming in Windows Forms</li>
<li>Describe crystal reports</li>
<li>Explain packaging and deploying Windows Forms applications</li>
			</ul>
</div>
</div>
