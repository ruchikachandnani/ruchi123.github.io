...
<div class="xyz" style="width: 400px;border: none;">
	<h2 style="text-transform: capitalize;"><center>C Programming</center></h2>
	<ul>
				<li>Describe the C programme structure</li>
<li>List the different data types</li>
<li>Use Operators</li>
<li>Use if-else-if statements</li>
<li>Discuss switch statement</li>
<li>Describe and implement loops</li>
<li>Describe array handling in C</li>
<li>Apply pointers in C</li>
<li>Define and use functions</li>
<li>List storage classes in C</li>
<li>List string functions</li>
<li>List the uses of structures in C</li>
